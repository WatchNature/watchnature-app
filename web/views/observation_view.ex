defmodule Watchnature.ObservationView do
  use Watchnature.Web, :view

  def render("index.json", %{observations: observations}) do
    %{data: render_many(observations, Watchnature.ObservationView, "observation.json")}
  end

  def render("show.json", %{observation: observation}) do
    %{data: render_one(observation, Watchnature.ObservationView, "observation.json")}
  end
